...
```bash
cd $SKILL_DIR  # path to the installed chrome-devtools skill scripts
...
## Workflow
- Use `plan` or the active DV workflow to organize the test plan and report
...
- Ask the user if they want to preview with `ck:preview`
