...
description: Create polished frontend interfaces from designs, screenshots, or videos. Use for dashboard UI, web components, replication work, quick prototypes, and immersive interfaces without AI slop.
...
Remember: the runtime is capable of extraordinary creative work. Commit fully to distinctive visions.
