...
```bash
python .agents/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python .agents/skills/ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python .agents/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python .agents/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
