...
python .agents/skills/ui-ux-pro-max/scripts/search.py "immersive 3d" --domain style
python .agents/skills/ui-ux-pro-max/scripts/search.py "animation" --domain ux
```
