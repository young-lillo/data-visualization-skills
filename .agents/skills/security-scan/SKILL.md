...
Lightweight security scanner using runtime reasoning plus shell tools. No external dependencies required.
...
| Code patterns | Grep + runtime analysis | Medium | `references/vulnerability-patterns.md` |
...
- Use runtime reasoning to determine if it's a real vulnerability or false positive
