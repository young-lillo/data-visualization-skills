...
Tracked runtime tasks are **ephemeral** — they die when the session ends. Plan files (plan.md, phase-XX.md with checkboxes) are the **persistent** layer.
